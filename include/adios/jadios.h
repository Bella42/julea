...
int j_adios_get_var_metadata_from_smd(char* name_space, Metadata* metadata, JSemantics* semantics);

int j_adios_get_all_attr_names_from_smd(char* name_space, char*** names, JSemantics* semantics);
int j_adios_get_attr_metadata_from_smd(char* name_space, Metadata* metadata, JSemantics* semantics);
